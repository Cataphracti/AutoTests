...
def test_open_drivers_list(browser):
    ...
    check_drivers_list = browser.find_element(By.CSS_SELECTOR, '#app > div > div.interior > div.interior__content > div.interior__body > div > div > div.drivers-list__top > div > div.ui-textbox__content > label > input')
