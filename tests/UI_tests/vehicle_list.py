...
def test_open_vehicles_list(browser):
    ...
    check_vehicles_list = browser.find_element(By.CSS_SELECTOR, 'body > div > div.interior > div.interior__content > div.interior__body > div > div > div.d-flex.flex-wrap.justify-content-between > div.ui-textbox.mb-4.ui-textbox--icon-position-left.ui-textbox--default.is-bordered > div.ui-textbox__content > label > input')
