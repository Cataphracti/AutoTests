...
def test_open_trailers_list(browser):
    ...
    check_trailers_list = browser.find_element(By.CSS_SELECTOR, 'body > div > div.interior > div.interior__content > div.interior__body > div > div > div.d-flex.justify-content-between > div > div.ui-textbox__content > label > input')
